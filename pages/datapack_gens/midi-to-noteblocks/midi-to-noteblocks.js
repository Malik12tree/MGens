...
function genCMD(n) {
    return `playsound ${n.instrument} master @s ~ ~ ~ ${(n.velocity * 1).toFixed(6)*1} ${notes[`octave${limitf(n.octave, 1 , 2)}`][n.pitch]}\n`
}
...
var instruments = {
    ...
    "chromatic percussion":     "block.note_block.chime", 
    "organ":                    "block.note_block.pling", 
    "guitar":                   "block.note_block.guitar", 
    "bass":                     "block.note_block.basedrum", 
    "strings":                  "block.note_block.bass", 
    "ensemble":                 "block.note_block.harp", 
    "brass":                    "block.note_block.didgeridoo", 
    "reed":                     "block.note_block.didgeridoo", 
    "pipe":                     "block.note_block.flute",
    "synth lead":               "block.note_block.bit", 
    "synth pad":                "block.note_block.cow_bell", 
    "synth effects":            "block.note_block.harp", 
    "world":                    "block.note_block.banjo",
    "percussive":               "block.note_block.bell", 
    "sound effects":            "block.note_block.chime",
    "drums":                    "block.note_block.snare"
}
